datablock ItemData(HKGuns_RiotGunItem)
{
	...
	image = HKGuns_RiotGunImage;
	canDrop = true;
};

datablock ShapeBaseImageData(HKGuns_RiotGunImage)
{
    // Basic Item properties
    shapeFile = $hgunsk@"Models/CR.dts";
    emap = true;
    ...
    //Colourshift
    doColorShift = false;
    colorShiftColor = HKGuns_RiotGunItem.colorShiftColor; //"0.400 0.196 0 1.000";
...
function reloadMisc_HKGuns_RiotGunImage(%this,%obj,%slot)
{
    //anims
