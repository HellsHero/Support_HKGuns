datablock ItemData(HKGuns_SniperItem)
{
	...
	doColorShift = false;
	colorShiftColor = "0.5 0.25 0.25 1.000";

	 // Dynamic properties defined by the scripts
	image = HKGuns_SniperImage;
	canDrop = true;
};

datablock ShapeBaseImageData(HKGuns_SniperImage)
{
    // Basic Item properties
    shapeFile = $hgunsk@"Models/CR.dts";
    emap = true;
    ...
    movementSpread = 50/100;		        /// Percent of spread increased by movement
    ...
    shellCount = 1;                         /// Not used if %player.overrideShells = true, this way it will use %player.shells for one firing cycle (sets .overrideShells to false and .shells to NULL after shooting)
    ...
    childImage[0] = "HKGuns_SniperHipImage"; /// Related image
    childImage[1] = "HKGuns_SniperSightImage";  
    ...
    //Colourshift
    doColorShift = false;
    colorShiftColor = HKGuns_SniperItem.colorShiftColor; //"0.400 0.196 0 1.000";
...
datablock ShapeBaseImageData(HKGuns_SniperHipImage)
{
    // Basic Item properties
    shapeFile = $hgunsk@"Models/CR.dts";
    emap = true;
    ...
    motherImage = "HKGuns_SniperImage"; /// Related image
    sisterImage = "HKGuns_SniperSightImage"; 
...
datablock ShapeBaseImageData(HKGuns_SniperSightImage)
{
    // Basic Item properties
    shapeFile = $hgunsk@"Models/CR.dts";
    emap = true;
    ...
    motherImage = "HKGuns_SniperImage";       /// Related image
    sisterImage = "HKGuns_SniperHipImage";
...
function reloadOutHKGuns_SniperImage(%this,%obj,%slot)
{
    %obj.playThread(2,shiftRight);
}

function reloadInHKGuns_SniperImage(%this,%obj,%slot)
{
    %obj.playThread(2,shiftAway);
}

function reloadDoneHKGuns_SniperImage(%this,%obj,%slot)
{
    %obj.playThread(2,shiftDown);
    %obj.schedule(300,playThread,2,plant);
}

function fireHKGuns_SniperHipImage(%this,%obj,%slot)
{
    %obj.playThread(2,plant);
}

function dryFireHKGuns_SniperHipImage(%this,%obj,%slot)
{
    %obj.playThread(2,plant);
}

function fireHKGuns_SniperSightImage(%this,%obj,%slot)
{
    %obj.playThread(2,plant);
}
function dryFireHKGuns_SniperSightImage(%this,%obj,%slot)
{
    %obj.playThread(2,plant);
}
